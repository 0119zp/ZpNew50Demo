...
public class ZpBehaviorNestedExpandActivity extends BaseActivity {
    ...
    private class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ContentHolder>{
        ...
        public ContentAdapter.ContentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ContentHolder(LayoutInflater.from(ZpBehaviorNestedExpandActivity.this).inflate(android.R.layout.simple_list_item_1, parent, false));
        }
