...
public class ZpAppBarLayoutActivity extends BaseActivity {
    ...
    private class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ContentHolder>{
        ...
        public ContentAdapter.ContentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ContentHolder(LayoutInflater.from(ZpAppBarLayoutActivity.this).inflate(R.layout.item_simple_list_1, parent, false));
        }
